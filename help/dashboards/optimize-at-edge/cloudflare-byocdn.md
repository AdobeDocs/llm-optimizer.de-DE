...
Nachdem Sie den Worker erstellt haben, klicken Sie auf **Code bearbeiten** und ersetzen Sie den Standard-Code durch Folgendes: Wenn Sie bereits über einen Cloudflare-Worker verfügen, führen Sie den unten stehenden Code mit Ihrem bestehenden Worker-Code zusammen, anstatt ihn vollständig zu ersetzen.
